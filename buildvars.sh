...
# which branch of the cFS tree will be used.
export CFS_BRANCH="master"

# The auto build system makes a clone of the cFS tree in order to build the applications.
# The following variable points to the get repository that is to be cloned.
