...
void OS_Application_Startup(void)
{
    ...
    */
    ...
    /*
    ** Assign the Spacecraft ID, CPU ID, CPU Name and CFS ID
    */
    ...
    */
    ...
    /*
     * Init Unique PSP shared memory segments Names
     */
    CFE_PSP_InitKeyFileNames(CFE_PSP_CpuName, CFE_PSP_CpuId);
    ...
    */
    Status = OS_FileSysAddFixedMap(&fs_id, CFE_PSP_CF_VIRTUAL_MAPPING, "/cf");
    if (Status != OS_SUCCESS)
    {
...
void OS_Application_Run(void)
{
    ...
    */
    ...
    /* Delete the SHM segments if flag set */
    if (CFE_PSP_IdleTaskState.DeleteSharedMemReq == true)
    {
        CFE_PSP_DeleteProcessorReservedMemory();
        CFE_PSP_IdleTaskState.DeleteSharedMemReq = false;
    }
...
void CFE_PSP_DisplayUsage(char *Name)
{
    printf("usage : %s [-R <value>] [-S <value>] [-C <value] [-N <value] [-I <value] [-F <value] [-h] \n", Name);
    printf("\n");
