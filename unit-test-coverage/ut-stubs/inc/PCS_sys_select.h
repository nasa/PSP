 ...
 * \ingroup ut-stubs
 *
 * Declarations and prototypes for PCS_sys_select
 */

#ifndef PCS_SYS_SELECT_H
#define PCS_SYS_SELECT_H

#include "PCS_basetypes.h"
#include "PCS_sys_time.h"

/* ------------------------------------------ */
/* constants normally defined in sys/select.h */
/* ------------------------------------------ */
#define PCS_FD_SETSIZE 10
...
typedef struct
{
    unsigned int fds[PCS_FD_SETSIZE];
} PCS_fd_set;
...
extern void PCS_FD_ZERO(PCS_fd_set *set);
