...
/*
 * ----------------------------------------------------
 * Generated stub function for CFE_PSP_ModuleInitList()
 * ----------------------------------------------------
 */
void CFE_PSP_ModuleInitList(CFE_PSP_ModuleListWrapper_t *WrapPtr, uint32 BaseId, CFE_StaticModuleLoadEntry_t *ListPtr)
{
    UT_GenStub_AddParam(CFE_PSP_ModuleInitList, CFE_PSP_ModuleListWrapper_t *, WrapPtr);
    UT_GenStub_AddParam(CFE_PSP_ModuleInitList, uint32, BaseId);
    UT_GenStub_AddParam(CFE_PSP_ModuleInitList, CFE_StaticModuleLoadEntry_t *, ListPtr);

    UT_GenStub_Execute(CFE_PSP_ModuleInitList, Basic, NULL);
}
...
/*
 * ----------------------------------------------------
 * Generated stub function for CFE_PSP_Module_SearchNameInList()
 * ----------------------------------------------------
 */
uint32 CFE_PSP_Module_SearchNameInList(const CFE_PSP_ModuleListWrapper_t *WrapPtr, const char *ModuleName)
{
    UT_GenStub_SetupReturnBuffer(CFE_PSP_Module_SearchNameInList, uint32);

    UT_GenStub_AddParam(CFE_PSP_Module_SearchNameInList, const CFE_PSP_ModuleListWrapper_t *, WrapPtr);
    UT_GenStub_AddParam(CFE_PSP_Module_SearchNameInList, const char *, ModuleName);

    UT_GenStub_Execute(CFE_PSP_Module_SearchNameInList, Basic, NULL);

    return UT_GenStub_GetReturnValue(CFE_PSP_Module_SearchNameInList, uint32);
}
